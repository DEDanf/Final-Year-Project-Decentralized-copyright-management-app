...
class AccountCreateTransaction extends TransactionBuilder_1.TransactionBuilder {
    ...
    setInitialBalance(balance) {
        const hbar = typeof balance === "number" ? Hbar_1.Hbar.fromTinybar(balance) : balance;
    ...
    setReceiveRecordThreshold(threshold) {
        const hbar = typeof threshold === "number" ? Hbar_1.Hbar.fromTinybar(threshold) : threshold;
        hbar._check({ allowNegative: false });
