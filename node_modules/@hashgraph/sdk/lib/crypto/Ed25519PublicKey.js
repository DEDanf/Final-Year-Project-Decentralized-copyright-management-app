...
class Ed25519PublicKey {
    ...
    static fromString(keyStr) {
        switch (keyStr.length) {
            case 64: { // raw public key
                const newKey = new Ed25519PublicKey(util_1.decodeHex(keyStr));
            ...
            case 88: // DER encoded public key
                if (keyStr.startsWith(util_1.ed25519PubKeyPrefix)) {
                    ...
                    const newKey = new Ed25519PublicKey(util_1.decodeHex(rawKey));
    ...
    toString(raw = false) {
        if (this._asStringRaw == null) {
            this._asStringRaw = util_1.encodeHex(this._keyData);
        }
