...
class QueryBuilder {
    ...
    setMaxQueryPayment(amount) {
        const hbar = typeof amount === "number" ? Hbar_1.Hbar.fromTinybar(amount) : amount;
    ...
    getCost(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { CryptoTransferTransaction } = yield Promise.resolve().then(() => require("./account/CryptoTransferTransaction"));
    ...
    _generatePaymentTransaction(client, node, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // HACK: Async import because otherwise there would a cycle in the imports which breaks everything
            const { CryptoTransferTransaction } = yield Promise.resolve().then(() => require("./account/CryptoTransferTransaction"));
            const paymentTx = yield new CryptoTransferTransaction()
